...
public class YellowTaxiServices : IEntityServices<Trips>
{
    ...
    public YellowTaxiServices(TaxiTripsContext taxiTripsContext, DataLoaderOptions dataLoaderOptions)
    {
        _entityLoader = new TripsDataLoader(taxiTripsContext);
        _entityReader = new YellowTripsDataReader();
    ...
    public void Synchronize()
    {
        ...
        try
        {
            tripsCollection = _entityReader.Read(_dataLoaderOptions.YellowTaxiFilePath);
        }
        catch (Exception ex)
        {
            throw new Exception($"Unable to read Yellow Taxi Data. Exception: {ex})");
        }
        ...
        if (tripsCollection.Any())
        {
            ...
            {
                throw new Exception($"Unable to load Yellow Taxi Data. Exception: {ex}");
            }
        }
    }
